...
cargo check --manifest-path=crate/async-proto/Cargo.toml --features=warp
cargo check --manifest-path=crate/async-proto/Cargo.toml --features=bytes,chrono,chrono-tz,either,enumset,git2,noisy_float,semver,serde_json,uuid
