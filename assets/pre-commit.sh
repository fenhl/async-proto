...
cargo check --manifest-path=crate/async-proto/Cargo.toml --features=bitvec,bytes,bytesize,chrono,chrono-tz,doubloon,either,enumset,git2,gix-hash,noisy_float,rust_decimal,semver,serde_json,serenity,url,uuid
